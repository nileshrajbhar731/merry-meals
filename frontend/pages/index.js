    ...
    <div className='home-main'>
      <div className="hero-container">
        <div className="hero-left">
          ...
          <a className='btn btn_success' href="register">Join Us</a>
        </div>
        <div className="hero-right">
          ...
          <img src={mealPlate2.src} alt="Meal Plate" />
        </div>
      </div>
      ...
      <div className='spec-section'>
        <div className='spec-container'>
          <div className='spec'>
            <img className='fishImg' src={fish.src} alt='' />
            <p>Nutritious</p>
          </div>
          <div className='spec'>
            <img className='strawberryImg' src={strawberry.src} alt='' />
            <p>Fresh</p>
          </div>
          <div className='spec'>
            <img className='leavesImg' src={leaves.src} alt='' />
            <p>Healthy</p>
          </div>
        </div>
      </div>
      ...
      <div className='why-container'>
        <div className='why-left'>
          <img src={cabbage.src} alt='cabbage' />
        </div>
        <div className='why-right'>
          ...
          <a className='btn btn_success' href='/about'>Learn More</a>
        </div>
      </div>
      ...
      <div className='contact-container'>
        ...
        <div className='contact-right'>
          <a className='btn btn_success' href='/contact'>Get in touch</a>
        </div>
      </div>
    </div>
  );
