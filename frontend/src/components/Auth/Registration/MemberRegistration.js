...
const MemberRegistration = ({ registeringCaregiver = false }) => {
  ...
  const submitForm = async (e) => {
    ...
    if (!emptyScheduleFound) {
      ...
      if (registeringCaregiver)
        sendData.append("isCaregiver", data.isCaregiver);
            ...
            <div className="form_container">
              <div className="form_row">
                <div className="form_grp">
                  ...
                  <label htmlFor="f_name">
                    {registeringCaregiver && "Member's"} First Name
                  </label>
                </div>
                <div className="form_grp">
                  <input
                  ...
                  <label htmlFor="l_name">
                    {registeringCaregiver && "Member's"} Last Name
                  </label>
                </div>
              </div>
              ...
              <div className="form_row">
                <div className="form_grp">
                  ...
                  />
                  <label htmlFor="phn">
                    {registeringCaregiver && "Member's"} Phone
                  </label>
                </div>
                <div className="form_grp">
                  <select
                  ...
                  <label htmlFor="select">
                    {registeringCaregiver && "Member's"} Gender
                  </label>
                </div>
              </div>
              ...
              <div className="form_row">
                <div className="form_grp">
                  ...
                  />
                  <label htmlFor="dob">
                    {registeringCaregiver && "Member's"} Date of Birth
                  </label>
                </div>
                <div className="form_grp">
                  <input
                  ...
                  <label htmlFor="profile">
                    {registeringCaregiver && "Member's"} Profile Photo
                  </label>
                  <AiOutlineUpload className="upload_icon" />
                </div>
              </div>
