...
const router=useRouter();
  ...
  const submitForm = async (e) => {
    ...
    if (meal.coreItems.length === 0) {
      ...
      //   verificationDoc: await getBase64(partner.verificationDoc),
      //   photo: await getBase64(partner.photo),
      //   name: meal.name,
      //   description: meal.description,
      //   isVeg: meal.mealType,
      //   photoUrl: await getBase64(meal.photo),
      //   coreItems: meal.coreItems,
      //   fats: meal.fats,
      //   carbs: meal.carbs,
      ...
      //   costPerMeal: partner.costPerMeal,
      // };
          ...
          >
            <div className="form_container">
              ...
              <div className="form_row">
                ...
                {/* <div className='form_grp'>
                                    <input required type='file' id='profile' onChange={e => { setPartner({ ...partner, photo: e.target.files[0] }) }} />
                                    <label htmlFor='profile'>Photo</label>
                                    <AiOutlineUpload className='upload_icon' />
                                </div> */}
              </div>
              ...
              <div className="form_row">
                ...
                {/* <div className='form_grp'>
                                    <input required type='file' id='doc' onChange={e => { setPartner({ ...partner, verificationDoc: e.target.files[0] }) }} />
                                    <label htmlFor='doc'>Verfication Document</label>
                                    <AiOutlineUpload className='upload_icon' />
                                </div> */}
              </div>
          ...
          <form onSubmit={submitForm}>
            <div className="form_container">
              ...
              <div className="form_row">
                ...
                {/* <div className='form_grp'>
                                    <input type='file' id='meal_photo' onChange={e => { setMeal({ ...meal, photo: e.target.files[0] }) }} required />
                                    <label htmlFor='meal_photo'>Meal Photo</label>
                                    <AiOutlineUpload className='upload_icon' />
                                </div> */}
              </div>
