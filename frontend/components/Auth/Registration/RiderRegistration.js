          ...
          >
            <div className="form_container">
              ...
              <div className="form_row">
                ...
                {/* <div className='form_grp'>
                                    <input required type='file' id='profile' onChange={e => { setData({ ...data, photo: e.target.files[0].name }) }} />
              ...
              <div className="form_row">
                ...
                {/* <div className='form_grp'>
                                    <input required type='file' id='doc_lisence' onChange={e => { setData({ ...data, lisenceDoc: e.target.files[0].name }) }} />
                                    <label htmlFor='doc_lisence'>Upload Lisence</label>
                                    <AiOutlineUpload className='upload_icon' />
                                </div> */}
              </div>
              ...
              <div className="form_row">
                ...
                {/* <div className='form_grp'>
                                    <input required type='file' id='doc_rc' onChange={e => { setData({ ...data, rcDoc: e.target.files[0].name }) }} />
                                    <label htmlFor='doc_rc'>Upload RC</label>
                                    <AiOutlineUpload className='upload_icon' />
                                </div> */}
              </div>
